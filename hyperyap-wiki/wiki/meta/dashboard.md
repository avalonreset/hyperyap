...
- BenjaminTerm install target: decommissioned in `v1.0.10`; the installer no longer downloads or launches it.
...
- Validate smart terminal copy, smart terminal paste, and paste undo in at least one stock Windows terminal.
