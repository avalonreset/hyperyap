        ...
        <Sidebar className="bg-background border-border border-r overflow-hidden w-[14.3rem]">
            ...
            <SidebarFooter className="bg-background ">
                <a
                    href={
                        version.length > 0
                            ? `https://github.com/avalonreset/legends-hyperyap/releases/tag/v${version}`
                            : 'https://github.com/avalonreset/legends-hyperyap/releases/latest'
                    }
                    target="_blank"
                ...
                <a
                    href="https://github.com/avalonreset/legends-hyperyap/issues/new"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground text-xs hover:text-foreground transition-colors flex items-center gap-2 px-2"
                >
