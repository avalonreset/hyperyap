    ...
    const benefits = [
        {
            ...
            description: t(
                'Say your word, we start transcribing instantly. No shortcut needed.'
            ),
        },
        {
            ...
            description: t(
                'Choose specific trigger words that feel natural to you.'
            ),
        },
        {
            icon: Zap,
            ...
            description: t(
                'Can also press Enter for you after transcription.'
            ),
        },
    ];
        ...
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full">
                {benefits.map((benefit) => (
                    <div
                        key={benefit.title}
                        className="bg-zinc-800/30 border border-zinc-800 p-5 rounded-xl space-y-3"
                    >
